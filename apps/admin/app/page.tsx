...
export default function Home() {
  ...
  const [section, setSection] = useState<'dashboard' | 'approvals' | 'setup-pending' | 'regions' | 'points' | 'location-matching' | 'ai-dashboard' | 'anomalies' | 'maintenance-calendar' | 'prospects' | 'audit-log' | 'point-details' | 'assignments' | 'paperwork' | 'point-timeline' | 'duplicates' | 'non-maintenance-visits' | 'sap-sync' | 'users' | 'new-user'>('dashboard');
    ...
    <main className="adminLayout">
      <aside className="sidebar">
        ...
        <nav className="sideNav">
          ...
          <button className={section === 'sap-sync' ? 'active' : ''} onClick={() => setSection('sap-sync')}>⇅ <span>SAP Senkronizasyonu</span></button>

...
import { confirmEfesim, EfesimExtractResult, extractEfesim } from './src/api';

type Step = 'START' | 'RESULT' | 'SAVED';
  ...
  async function beginEfesimFlow() {
    ...
    try {
      ...
      if (!locationPermission.granted) {
        Alert.alert('Konum gerekli', 'Google eşleştirmesi ve ziyaret kaydı için konum izni gerekli.');
        return;
      }
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        {step === 'SAVED' && (
          <View style={styles.card}>
            <Text style={styles.success}>Aday müşteri oluşturuldu</Text>
            <Text style={styles.help}>Şimdi bu aday için Keşif veya Kurma ziyareti kaydedilebilir.</Text>
            <PrimaryButton title="YENİ ADAY" onPress={reset} disabled={busy} />
          </View>
        )}

  ...
  async due(asOfInput?: string) {
    ...
    const standardRows = Array.from(standardByPoint.values()).flatMap((obligations) => {
      ...
      return [{
        ...
        coolerCount: oldest.point.coolerCount, towerCount: oldest.point.towerCount, tapCount: oldest.point.tapCount, smarttapCount: oldest.point.smarttapCount,
    ...
    const smartcleanRows = smartcleanPoints
      .map((point) => {
        ...
        return {
          ...
          coolerCount: point.coolerCount, towerCount: point.towerCount, tapCount: point.tapCount, smarttapCount: point.smarttapCount,
          dueStart: dueDate,
          dueEnd: dueDate,
